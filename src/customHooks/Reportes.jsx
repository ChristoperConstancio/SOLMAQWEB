                    ...
                    <View style={tw("table border border-solid border-t-0 border-l-0 border-r border-b-0")}>
                        ...
                        <View style={tw("mx-auto flex-row")}>
                            <View style={tw("w-1/5 border border-solid border-t-0 border-l-0")}>
                                <Text style={tw("mx-auto mt-5 text-sm")}>{informacion[0].nuCobro}</Text>
                            </View>
                            <View style={tw("w-1/5 border border-solid border-t-0 border-l-0")}>
                                <Text style={tw("mx-auto mt-5 text-sm")}>{informacion[0].fecha} </Text>
                            </View>
                            <View style={tw("w-1/5 border border-solid border-t-0 border-l-0")}>
                                <Text style={tw("mx-auto mt-5 text-sm")}>{informacion[0].tipoPago}</Text>
                            </View>
                            <View style={tw("w-1/5 border border-solid border-t-0 border-l-0")}>
                                <Text style={tw("mx-auto mt-5 text-sm")}>{informacion[0].monto}</Text>
                            </View>
                            <View style={tw("w-1/5 border border-solid border-t-0 border-l-0")}>
                                <Text style={tw("mx-auto mt-5 text-sm")}>{informacion[0].saldo}</Text>
                            </View>
                        </View>
                    </View>
