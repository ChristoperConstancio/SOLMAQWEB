...
function AgregarCobro() {
    ...
    const salvar = async () => {
        ...
        if (saldo < confirmar) {
            alert("Monto mas grande que el saldo");
            return;
        }
        ...
        setCobro({ ...cobro, fecha: date, nuVenta, nuCobro, rastreo })
        setDisponible(true);
    ...
    const handleInputChange = () => {
        ...
        if (x == confirmar) {
            ...
            setCobro({ ...cobro, monto: x, saldo: cantidad, total : venta.saldo })
        }
    }
    useEffect(() => {
    ...
    return (
        <div className='h-screen bg-black '>
            <div className='mx-20 py-10 grid grid-cols-2 gap-y-8 gap-x-8   ' id='add'>
                ...
                <div className='space-x-8 '>
                    <label htmlFor="" className='text-white text-3xl'>Clave rastreo :</label>
                    <input className='pl-3 rounded-lg w-72 h-10' type="text" id='rastreo'/>
                </div>
                <div className='space-x-8 '>
